...
const Orden = ({orden}) => {
    ...
    const definirTiempo=(id)=>{
        try{
            firebase.db.collection('pedidos').doc(id).update({
                ...
                <div className="p-3 shadow-md bg-white">
                    ...
                    {orden.tiempoentrega===0 &&(
                        <div className="mb-4">
                            ...
                            type="submit"
                            className="bg-gray-800 hover:bg-gray-900 transition-all duration-300 ease-in-out text-white w-full mt-5 p-2 uppercase font-bold"
                            >
                                Definir Tiempo
                            </button>
                        </div>
                    ...
                    {!orden.completado &&orden.tiempoentrega>0 &&(
                        <button 
                        type="button"
                        className="bg-blue-800 hover:bg-blue-700 transition-all duration-300 ease-in-out w-full mt-5 p-2 text-white uppercase font-bold"
